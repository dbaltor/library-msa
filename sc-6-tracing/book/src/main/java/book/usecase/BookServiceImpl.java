...
public class BookServiceImpl implements BookService {
    ...
    public static final String BOOK_BORROWED_METRIC = "book.borrowed";
    public static final String BOOK_RETURNED_METRIC = "book.returned";
    public static final String BOOK_BORROWING_ERROR_METRIC = "book.borrowing.error";
    public static final String BOOK_RETURNING_ERROR_METRIC = "book.returning.error";
    ...
    @NonNull private MeterRegistry meterRegistry;
    ...
    public List<Book> borrowBooks(List<Book> booksToBorrow, Long readerId) throws BorrowingException {
        ...
        if (!errors.isEmpty()){
            meterRegistry.counter(BOOK_BORROWING_ERROR_METRIC).increment(errors.size()); // count business metric
        ...
        meterRegistry.counter(BOOK_BORROWED_METRIC).increment(newBorrowedBooks.size()); // count business metric
    ...
    public List<Book> returnBooks(List<Book> booksToReturn, Long readerId) throws ReturningException {
        ...
        val errors = readerEntity.bookReturningValidator(
            ...
            findBooksByReaderId(readerId));
        if (!errors.isEmpty()){
            meterRegistry.counter(BOOK_RETURNING_ERROR_METRIC).increment(errors.size()); // count business metric
        ...
        meterRegistry.counter(BOOK_RETURNED_METRIC).increment(returnedBooks.size()); // count business metric
